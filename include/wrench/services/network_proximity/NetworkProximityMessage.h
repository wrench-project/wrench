...
namespace wrench {
    ...
    public:
        NetworkProximityLookupRequestMessage(S4U_Mailbox *answer_mailbox, std::pair<std::string, std::string> hosts,
                                             double payload);
    ...
    public:
        NextContactDaemonAnswerMessage(std::string next_host_to_send,
                                       ...
                                       S4U_Mailbox *next_mailbox_to_send, double payload);
        ...
        S4U_Mailbox *next_mailbox_to_send;
    };
    ...
    public:
        CoordinateLookupRequestMessage(S4U_Mailbox *answer_mailbox, std::string requested_host, double payload);
