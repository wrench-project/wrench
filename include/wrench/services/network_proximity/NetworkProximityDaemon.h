...
namespace wrench {
    ...
    public:
        ...
        NetworkProximityDaemon(Simulation *simulation, std::string hostname,
                               ...
                               double noise, int noise_seed, std::unordered_map<std::string, double> messagepayload_list);
    ...
    private:
        ...
        NetworkProximityDaemon(Simulation *simulation, std::string hostname,
                               simgrid::s4u::Mailbox *network_proximity_service_mailbox,
                               double message_size,double measurement_period,
                               double noise, int noise_seed, std::unordered_map<std::string, double> messagepayload_list, std::string suffix);
