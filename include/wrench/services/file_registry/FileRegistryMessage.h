...
namespace wrench {
    ...
    public:
        FileRegistryFileLookupRequestMessage(S4U_Mailbox *answer_mailbox, const std::shared_ptr<DataFile> &file, double payload);
    ...
    public:
        FileRegistryFileLookupByProximityRequestMessage(S4U_Mailbox *answer_mailbox, std::shared_ptr<DataFile> file,
    ...
    public:
        FileRegistryRemoveEntryRequestMessage(S4U_Mailbox *answer_mailbox,
    ...
    public:
        FileRegistryAddEntryRequestMessage(S4U_Mailbox *answer_mailbox,
                                           std::shared_ptr<FileLocation> location, double payload);
