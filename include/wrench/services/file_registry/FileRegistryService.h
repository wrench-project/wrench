...
namespace wrench {
    ...
    private:
        ...
        WRENCH_MESSAGE_PAYLOADCOLLECTION_TYPE default_messagepayload_values = {
                {FileRegistryServiceMessagePayload::STOP_DAEMON_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::DAEMON_STOPPED_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::FILE_LOOKUP_REQUEST_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::FILE_LOOKUP_ANSWER_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::REMOVE_ENTRY_REQUEST_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::REMOVE_ENTRY_ANSWER_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::ADD_ENTRY_REQUEST_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
                {FileRegistryServiceMessagePayload::ADD_ENTRY_ANSWER_MESSAGE_PAYLOAD, S4U_Mailbox::default_control_message_size},
        };
    ...
    private:
        ...
        void addEntryToDatabase(const std::shared_ptr<FileLocation> &location);

        bool removeEntryFromDatabase(const std::shared_ptr<FileLocation> &location);
