...
/**
 * @brief A message sent to a VirtualizedClusterComputeService to request a VM
 * migration
 */
...
/**
 * @brief A message sent by a VirtualizedClusterComputeService in answer to a VM
 * migration request
 */
