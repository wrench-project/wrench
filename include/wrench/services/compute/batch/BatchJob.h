...
namespace wrench {
    ...
    public:
        ...
        BatchJob(const std::shared_ptr<CompoundJob> &job, unsigned long job_id, unsigned long time_in_seconds, unsigned long num_nodes,
    ...
    private:
        ...
        std::map<simgrid::s4u::Host *, std::tuple<unsigned long, sg_size_t>> resources_allocated;
