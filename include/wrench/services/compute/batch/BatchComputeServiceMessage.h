...
/**
 * @brief A message sent to a BatchComputeService to submit a batch job for
 * execution
 */
class BatchComputeServiceJobRequestMessage : public BatchComputeServiceMessage {
public:
  BatchComputeServiceJobRequestMessage(S4U_CommPort *answer_commport,
 ...
 *        BatchComputeService to tell it to start a job execution, passing it
 * the JSON reply received from Batsched
 */
class BatchExecuteJobFromBatSchedMessage : public BatchComputeServiceMessage {
public:
  BatchExecuteJobFromBatSchedMessage(S4U_CommPort *answer_commport,
...
/**
 * @brief A message send by a BatschedNetworkListener to a Batsched-enabled
 * BatchComputeService with a job start time estimate obtained from Batsched
 */
