...
namespace wrench {
     ...
     */
    class ServerlessComputeServiceMessagePayload : public ServiceMessagePayload {
    public:

        /** @brief The number of bytes in a control message sent by the Serverless Compute Service to register a function*/    
