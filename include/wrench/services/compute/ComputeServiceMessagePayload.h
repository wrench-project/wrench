...
public:
  ...
  /** @brief The number of bytes in the control message sent by the daemon to
   * acknowledge a standard job termination **/
  ...
  /** @brief The number of bytes in the control message sent by the daemon to
   * acknowledge a compound job termination **/
  ...
  /** @brief The number of bytes in the control message sent from the daemon to
   * acknowledge a pilot job submission **/
  DECLARE_MESSAGEPAYLOAD_NAME(SUBMIT_PILOT_JOB_ANSWER_MESSAGE_PAYLOAD);
  /** @brief The number of bytes in the control message sent by the daemon to
   * state that a pilot job has started **/
  DECLARE_MESSAGEPAYLOAD_NAME(PILOT_JOB_STARTED_MESSAGE_PAYLOAD);
  /** @brief The number of bytes in the control message sent by the daemon to
   * state that a pilot job has expired **/
  DECLARE_MESSAGEPAYLOAD_NAME(PILOT_JOB_EXPIRED_MESSAGE_PAYLOAD);
  /** @brief The number of bytes in the control message sent by the daemon to
   * state that a pilot job has failed **/
