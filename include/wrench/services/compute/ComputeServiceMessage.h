...
//    /**
//    * @brief A message sent to a ComputeService to submit a StandardJob for
//    execution
//    */
//    class ComputeServiceSubmitStandardJobRequestMessage : public
//    ComputeServiceMessage { public:
//        ComputeServiceSubmitStandardJobRequestMessage(const std::string
//        answer_commport, std::shared_ptr<StandardJob> ,
//                                                      const
//                                                      std::map<std::string,
//                                                      std::string>
...
//                                                      double payload);
//
//        /** @brief The commport_name to which the answer message should be
//        sent */ std::string answer_commport;
...
//    /**
//     * @brief  A message sent by a ComputeService in answer to a StandardJob
//     submission request
//     */
//    class ComputeServiceSubmitStandardJobAnswerMessage : public
//    ComputeServiceMessage { public:
//        ComputeServiceSubmitStandardJobAnswerMessage(std::shared_ptr<StandardJob>
//        , std::shared_ptr<ComputeService>, bool success,
//                                                     std::shared_ptr<FailureCause>
//                                                     failure_cause, double
//                                                     payload);
//
...
//    /**
//     * @brief A message sent by a ComputeService when a StandardJob has
//     completed execution
//     */
//    class ComputeServiceStandardJobDoneMessage : public ComputeServiceMessage
//    { public:
//        ComputeServiceStandardJobDoneMessage(std::shared_ptr<StandardJob> ,
//        std::shared_ptr<ComputeService>, double payload);
//
...
//
//    /**
//     * @brief A message sent by a ComputeService when a StandardJob has failed
//     to execute
//     */
//    class ComputeServiceStandardJobFailedMessage : public
//    ComputeServiceMessage { public:
//        ComputeServiceStandardJobFailedMessage(std::shared_ptr<StandardJob> ,
//        std::shared_ptr<ComputeService>,
//                                               std::shared_ptr<FailureCause>
//                                               cause, double payload);
//
...
//
//    /**
//    * @brief A message sent to a ComputeService to terminate a StandardJob
//    previously submitted for execution
//    */
//    class ComputeServiceTerminateStandardJobRequestMessage : public
//    ComputeServiceMessage { public:
//        ComputeServiceTerminateStandardJobRequestMessage(std::string
//        answer_commport, std::shared_ptr<StandardJob> , double payload);
//
//        /** @brief The commport_name to which the answer message should be
//        sent */ std::string answer_commport;
...
//     termination request
//     */
//    class ComputeServiceTerminateStandardJobAnswerMessage : public
//    ComputeServiceMessage { public:
//        ComputeServiceTerminateStandardJobAnswerMessage(std::shared_ptr<StandardJob>
//        , std::shared_ptr<ComputeService>, bool success,
//                                                        std::shared_ptr<FailureCause>
//                                                        failure_cause, double
//                                                        payload);
...
/**
 * @brief A message sent to a ComputeService to submit a CompoundJob for
 * execution
 */
...
public:
  ComputeServiceSubmitCompoundJobRequestMessage(
      ...
      std::map<std::string, std::string> service_specific_args, double payload);
...
/**
 * @brief  A message sent by a ComputeService in answer to a CompoundJob
 * submission request
 */
...
public:
  ComputeServiceSubmitCompoundJobAnswerMessage(
      std::shared_ptr<CompoundJob>, std::shared_ptr<ComputeService>,
...
/**
 * @brief A message sent by a ComputeService when a CompoundJob has completed
 * execution
 */
class ComputeServiceCompoundJobDoneMessage : public ComputeServiceMessage {
public:
  ComputeServiceCompoundJobDoneMessage(std::shared_ptr<CompoundJob>,
                                       std::shared_ptr<ComputeService>,
                                       double payload);
...
/**
 * @brief A message sent by a ComputeService when a CompoundJob has failed to
 * execute
 */
class ComputeServiceCompoundJobFailedMessage : public ComputeServiceMessage {
public:
  ComputeServiceCompoundJobFailedMessage(std::shared_ptr<CompoundJob>,
                                         std::shared_ptr<ComputeService>,
                                         double payload);
...
/**
 * @brief A message sent to a ComputeService to terminate a CompoundJob
 * previously submitted for execution
 */
...
public:
  ComputeServiceTerminateCompoundJobRequestMessage(
      S4U_CommPort *answer_commport, std::shared_ptr<CompoundJob>,
      double payload);
...
/**
 * @brief A message sent by a ComputeService when a PilotJob has started its
 * execution
 */
class ComputeServicePilotJobStartedMessage : public ComputeServiceMessage {
public:
  ComputeServicePilotJobStartedMessage(std::shared_ptr<PilotJob>,
                                       std::shared_ptr<ComputeService>,
                                       double payload);
...
public:
  ComputeServicePilotJobExpiredMessage(std::shared_ptr<PilotJob>,
                                       std::shared_ptr<ComputeService>,
                                       double payload);
...
/**
 * @brief A message sent to a ComputeService to request information on its
 * compute resources
 */
class ComputeServiceResourceInformationRequestMessage
    : public ComputeServiceMessage {
public:
  ComputeServiceResourceInformationRequestMessage(S4U_CommPort *answer_commport,
...
/**
 * @brief A message sent by a ComputeService in answer to a resource information
 * request
 */
...
/**
 * @brief A message sent to a ComputeService to asks if at least one host has
 * some available resources right now
 */
...
/**
 * @brief A message sent by a ComputeService in answer to a "does at least one
 * host have these available resources" request
 */
