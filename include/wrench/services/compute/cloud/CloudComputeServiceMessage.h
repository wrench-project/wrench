...
namespace wrench {
    ...
    public:
        CloudComputeServiceGetExecutionHostsRequestMessage(S4U_Mailbox *answer_mailbox, double payload);
    ...
    public:
        CloudComputeServiceCreateVMRequestMessage(S4U_Mailbox *answer_mailbox,
    ...
    public:
        CloudComputeServiceShutdownVMRequestMessage(S4U_Mailbox *answer_mailbox,
    ...
    public:
        CloudComputeServiceStartVMRequestMessage(S4U_Mailbox *answer_mailbox,
                                                 const std::string &vm_name,
                                                 double payload);
    ...
    public:
        CloudComputeServiceSuspendVMRequestMessage(S4U_Mailbox *answer_mailbox,
                                                   const std::string &vm_name,
                                                   double payload);
    ...
    public:
        CloudComputeServiceResumeVMRequestMessage(S4U_Mailbox *mailbox,
                                                  const std::string &vm_name,
                                                  double payload);
    ...
    */
    ...
    public:
        CloudComputeServiceDestroyVMRequestMessage(S4U_Mailbox *answer_mailbox,
                                                   const std::string &vm_name,
                                                   double payload);
