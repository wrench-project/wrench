...
public:
  ...
  /** @brief The VM resource allocation algorithm by which VMs are started on
   *physical hosts. Possible values are:
   *      - best-fit-ram-first (default): Start VMs on hosts using a best-fit
   *algorithm, considering first the RAM and then the number of cores
   ...
   *      - first-fit: a first-fit algorithm based on the order of the physical
   *host list
   *
   **/
