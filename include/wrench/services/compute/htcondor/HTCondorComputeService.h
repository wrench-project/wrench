...
private:
  ...
  WRENCH_MESSAGE_PAYLOADCOLLECTION_TYPE default_messagepayload_values = {
      {HTCondorComputeServiceMessagePayload::STOP_DAEMON_MESSAGE_PAYLOAD,
      ...
      {HTCondorComputeServiceMessagePayload::PILOT_JOB_STARTED_MESSAGE_PAYLOAD,
       S4U_CommPort::default_control_message_size}, // for forwarding
      {HTCondorComputeServiceMessagePayload::
...
public:
  ...
  //        void submitPilotJob(std::shared_ptr<PilotJob> job, const
  ...
  void
  setLocalStorageService(std::shared_ptr<StorageService> local_storage_service);
...
private:
  ...
  //        void processSubmitStandardJob(const std::string &answer_commport,
  //        std::shared_ptr<StandardJob>job,
  //                                      const std::map<std::string,
  //                                      std::string> &service_specific_args);
  //
  //        void processSubmitPilotJob(const std::string &answer_commport,
