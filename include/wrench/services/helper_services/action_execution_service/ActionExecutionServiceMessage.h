...
public:
  ActionExecutionServiceSubmitActionRequestMessage(
      S4U_CommPort *reply_commport, std::shared_ptr<Action> action,
      double payload);
...
/**
 * @brief A message sent by an ActionExecutionService in answer to an Action
 * submission
 */
...
/**
 * @brief A message sent by an ActionExecutionService in response to an action
 * termination
 */
...
/**
 * @brief A message sent by an ActionExecutionService to notify of an action's
 * completion
 */
class ActionExecutionServiceActionDoneMessage
    : public ActionExecutionServiceMessage {
public:
  ActionExecutionServiceActionDoneMessage(std::shared_ptr<Action> action,
                                          double payload);
