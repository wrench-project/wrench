...
#define DECLARE_PROPERTY_NAME(name)                                            \
  static const wrench::WRENCH_PROPERTY_TYPE name
#define SET_PROPERTY_NAME(classname, name)                                     \
  const wrench::WRENCH_PROPERTY_TYPE classname::name =                         \
      classname::addServiceProperty(#classname, #name)
...
public:
  static WRENCH_PROPERTY_TYPE addServiceProperty(std::string classname,
                                                 std::string messagePayload);
  static WRENCH_PROPERTY_TYPE translateString(std::string serviceProperty);
  static std::string
  translatePropertyType(WRENCH_PROPERTY_TYPE serviceProperty);
};
