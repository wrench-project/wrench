...
/**
 * @brief A message sent to a CompoundStorageService to request a storage
 * allocation for a file
 */
class CompoundStorageAllocationRequestMessage
    : public CompoundStorageServiceMessage {
public:
...
/**
 * @brief A message sent by a StorageService in answer to a storage selection
 * request
 */
class CompoundStorageAllocationAnswerMessage
    : public CompoundStorageServiceMessage {
public:
  CompoundStorageAllocationAnswerMessage(
 ...
 * allocation for a file
 */
class CompoundStorageLookupRequestMessage
    : public CompoundStorageServiceMessage {
public:
  CompoundStorageLookupRequestMessage(S4U_CommPort *answer_commport,
                                      std::shared_ptr<DataFile> file,
                                      double payload);
 ...
 * request
 */
class CompoundStorageLookupAnswerMessage
    : public CompoundStorageServiceMessage {
public:
