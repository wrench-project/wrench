...
namespace wrench {
    ...
    private:
        ...
        void receiveFileFromNetwork(const std::shared_ptr<DataFile> &f, S4U_Mailbox *mailbox, const std::shared_ptr<FileLocation> &location);
        void sendLocalFileToNetwork(const std::shared_ptr<DataFile> &f, const std::shared_ptr<FileLocation> &location, double num_bytes, S4U_Mailbox *mailbox);
