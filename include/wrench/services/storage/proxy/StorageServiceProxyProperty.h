...
namespace wrench {
    ...
    public:
         ...
         *  ------------------------------------------------------
         *  |File to client time| Overestimated | Probiably good| Accurate|
         *  ------------------------------------------------------
         *  |Network Congestion| Accurate   |Underestimated | Accurate|
         *  ------------------------------------------------------
         *  |Parrallel behavior| No change | Amplifies weakness| Decreased accuracy for secondary Host|
         *  ------------------------------------------------------
         *  |Required Network Links| Proxy-Remote, Client-Proxy|Proxy-Remote, Client-Proxy|Client-Remote, Client-Proxy|
         *  ------------------------------------------------------
         **/
