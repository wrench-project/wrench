...
namespace wrench {
    ...
    public:
        ...
        ServiceStopDaemonMessage(S4U_Mailbox *ack_mailbox, bool send_failure_notifications, ComputeService::TerminationCause termination_cause, double payload);

        /** @brief the mailbox to which the "I stopped" ack should be sent */
        S4U_Mailbox *ack_mailbox;
