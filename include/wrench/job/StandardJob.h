...
namespace wrench {
    ...
    private:
        ...
        static void applyTaskUpdates(const std::map<std::shared_ptr<WorkflowTask>, WorkflowTask::State> &state_changes,
                                     const std::set<std::shared_ptr<WorkflowTask>> &failure_count_increments);
