...
public:
  DataManagerFileWriteAnswerMessage(
 ...
 */
class DataMovementManagerFileReaderThreadMessage
    : public DataMovementManagerMessage {
public:
 ...
 * @brief A message sent to a DataMovementManager from a FileReaderThread
 */
class DataMovementManagerFileWriterThreadMessage
    : public DataMovementManagerMessage {
public:
