...
/**
 * @brief An internal class that uses the Boost Graph Library to implement a DAG
 * of WorkflowTask objects
 */
class DagOfTasks {
...
private:
  ...
  public:
    ...
    explicit custom_bfs_visitor(const WorkflowTask *target_task)
