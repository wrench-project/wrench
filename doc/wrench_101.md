...
-# **Create and initialize a simulation** -- In WRENCH, a user simulation is defined via the `wrench::Simulation` class. 
 ...
 simulation (and parse WRENCH-specific and [SimGrid-specific](https://simgrid.org/doc/latest/outcomes.html) 
...
-# **Instantiate a simulated platform** --  This is done with the `wrench::Simulation::instantiatePlatform()`
 ...
 Any [SimGrid](http://simgrid.org) simulation must be provided with the description 
...
WRENCH leverages [SimGrid's energy plugin](https://simgrid.org/doc/latest/Configuring_SimGrid.html),
