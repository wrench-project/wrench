...
breathe_projects = {
    "user": "../../docs/2.3-dev/user/xml/",
    "developer": "../../docs/2.3-dev/developer/xml/",
    "internal": "../../docs/2.3-dev/internal/xml/",
}
version = '2.3-dev'
release = '2.3-dev'
...
breathe_projects = {
    "user": "../../docs/2.9-dev/user/xml/",
    "developer": "../../docs/2.9-dev/developer/xml/",
    "internal": "../../docs/2.9-dev/internal/xml/",
}
version = '2.9-dev'
release = '2.9-dev'
