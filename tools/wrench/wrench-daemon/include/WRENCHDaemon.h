...
/**
 * @brief A class that implements a the main wrench-daemon process (in the run()
 * method)
 */
class WRENCHDaemon {

public:
  WRENCHDaemon(bool simulation_logging, bool daemon_logging, int port_number,
               const std::string &allowed_origin, int sleep_us);
