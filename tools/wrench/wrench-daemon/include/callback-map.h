...
request_handlers["submit"] = [sc](json data) { return sc->submitCompoundJob(std::move(data)); };
request_handlers["setPriority"] = [sc](json data) { return sc->getTaskFlops(std::move(data)); };
request_handlers["addParentJob"] = [sc](json data) { return sc->addParentJob(std::move(data)); };
...
request_handlers["addSleepAction"] = [sc](json data) { return sc->addSleepAction(std::move(data)); };
request_handlers["addComputeAction"] = [sc](json data) { return sc->addComputeAction(std::move(data)); };
request_handlers["addFileCopyAction"] = [sc](json data) { return sc->addFileCopyAction(std::move(data)); };
request_handlers["addFileDeleteAction"] = [sc](json data) { return sc->addFileDeleteAction(std::move(data)); };
request_handlers["addFileReadAction"] = [sc](json data) { return sc->addFileReadAction(std::move(data)); };
request_handlers["addFileWriteAction"] = [sc](json data) { return sc->addFileWriteAction(std::move(data)); };
