...
/**
 * @brief A class that handles all simulation changes and holds all simulation
 * state.
 */
...
public:
  ...
  void createSimulation(bool full_log, const std::string &platform_xml,
                        const std::string &controller_host, int sleep_us);
  ...
  std::shared_ptr<wrench::SimulationController> getController() const {
