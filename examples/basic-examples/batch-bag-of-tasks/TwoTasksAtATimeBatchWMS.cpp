...
namespace wrench {
     ...
     */
    TwoTasksAtATimeBatchWMS::TwoTasksAtATimeBatchWMS(const std::set<std::shared_ptr<ComputeService>> &compute_services,
    ...
    int TwoTasksAtATimeBatchWMS::main() {
        ...
        while (not this->getWorkflow()->isDone()) {
            ...
            job_manager->submitJob(standard_job, batch_service, service_specific_arguments);
