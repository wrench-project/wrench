...
protected:
  void processEventStandardJobCompletion(
      std::shared_ptr<StandardJobCompletedEvent> event) override;
  void processEventStandardJobFailure(
      std::shared_ptr<StandardJobFailedEvent> event) override;
  void processEventPilotJobStart(
      std::shared_ptr<PilotJobStartedEvent> event) override;
  void processEventPilotJobExpiration(
      std::shared_ptr<PilotJobExpiredEvent> event) override;
