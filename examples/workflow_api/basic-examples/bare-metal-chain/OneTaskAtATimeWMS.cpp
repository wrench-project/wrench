 ...
 */
OneTaskAtATimeWMS::OneTaskAtATimeWMS(
    std::shared_ptr<Workflow> workflow,
    const std::shared_ptr<BareMetalComputeService> &bare_metal_compute_service,
    const std::shared_ptr<SimpleStorageService> &storage_service,
    const std::string &hostname)
    : ExecutionController(hostname, "one-task-at-a-time"), workflow(workflow),
 ...
 */
void OneTaskAtATimeWMS::processEventStandardJobCompletion(
 ...
 * @param event: the event
 */
void OneTaskAtATimeWMS::processEventStandardJobFailure(
