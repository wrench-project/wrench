...
int main(int argc, char **argv) {
  ...
  if (argc < 4) {
    std::cerr
        << "Usage: " << argv[0]
        << " <file_size_gb> <cpu_time_sec> <xml_platform_file> "
  ...
  /* Declare a workflow */
  auto workflow =
      generate_workflow(1, num_tasks, 1, cpu_time_sec * 1000000000,
  ...
  {
    std::string filename = "output_single_" + sub_dir +
                           to_string(file_size_gb) + "gb_sim_time.csv";
