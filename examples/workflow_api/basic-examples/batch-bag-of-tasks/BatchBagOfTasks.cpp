 ...
 **    ./wrench-example-batch_standard_and_pilot_jobs-bag-of-tasks 10 ./dragonfly_cluster.xml
 **
 ** Example invocation of the simulator for a 10-task workflow, with only WMS logging:
 **    ./wrench-example-batch_standard_and_pilot_jobs-bag-of-tasks 10 ./dragonfly_cluster.xml --log=custom_wms.threshold=info
 **
 ** Example invocation of the simulator for a 6-task workflow with full logging:
 **    ./wrench-example-batch_standard_and_pilot_jobs-bag-of-tasks 6 ./dragonfly_cluster.xml --wrench-full-log
 **/
