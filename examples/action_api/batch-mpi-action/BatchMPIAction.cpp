 ...
 **    ./wrench-example-mpi-action ./dragonfly_cluster.xml --log=custom_controller.threshold=info
 **
 ** Example invocation of the simulator with full logging:
 **    ./wrench-example-wrench-example-mpi-action ./dragonfly_cluster.xml --wrench-full-log
 **/
...
int main(int argc, char **argv) {
    ...
    auto wms = simulation->add(
            new wrench::BatchMPIActionController(batch_service, storage_service, host_list.at(0)));
