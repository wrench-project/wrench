...
#ifndef WRENCH_EXAMPLE_MULTI_ACTION_MULTI_JOB_H
#define WRENCH_EXAMPLE_MULTI_ACTION_MULTI_JOB_H
...
namespace wrench {
     ...
     */
    class MultiActionMultiJobWMS : public WMS {

    public:
        // Constructor
        MultiActionMultiJobWMS(
...
#endif //WRENCH_EXAMPLE_MULTI_ACTION_MULTI_JOB_H
