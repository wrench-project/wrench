...
namespace wrench {
    ...
    int MultiActionMultiJobController::main() {
        ...
        wrench::StorageService::createFileAtLocation(wrench::FileLocation::LOCATION(ss_1, "/data/", input_file));
        ...
        /* Wait for and react to execution events. We should be getting 3 "job completed" events */
        int num_events = 0;
        while (num_events < 3) {
