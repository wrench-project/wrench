...
WRENCH_LOG_CATEGORY(simulation_logging_test,
                    "Log category for Simulation Logging Test");
...
public:
  SimulationLoggingWMS(SimulationLoggingTest *test, std::string &hostname)
...
TEST_F(SimulationLoggingTest, Logging) { DO_TEST_WITH_FORK(do_logging_test); }
