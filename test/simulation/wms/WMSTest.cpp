...
void WMSTest::do_DefaultHandlerWMS_test() {
  ...
  execution_hosts.push_back(simulation->getHostnameList()[1]);
  ASSERT_NO_THROW(compute_service = simulation->add(
          new wrench::CloudService(hostname1, execution_hosts, 100.0, {}, {})));
