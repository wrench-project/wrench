...
TEST_F(MessageConstructorTest, ComputeServiceMessages) {
    ...
    new wrench::ComputeServiceSubmitStandardJobRequestMessage("mailbox", standard_job, args, 666);
...
TEST_F(MessageConstructorTest, CloudComputeServiceMessages) {
    ...
    ASSERT_NO_THROW(new wrench::CloudComputeServiceShutdownVMRequestMessage("mailbox", "vm", false, wrench::ComputeService::TerminationCause::TERMINATION_NONE, 666));
    ASSERT_THROW(new wrench::CloudComputeServiceShutdownVMRequestMessage("", "vm", false, wrench::ComputeService::TerminationCause::TERMINATION_NONE, 666), std::invalid_argument);
    ASSERT_THROW(new wrench::CloudComputeServiceShutdownVMRequestMessage("mailbox", "", false, wrench::ComputeService::TerminationCause::TERMINATION_NONE, 666), std::invalid_argument);
