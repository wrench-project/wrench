...
//        CUSTOM_THROW(new wrench::FileRegistryFileLookupAnswerMessage({}, 666), std::invalid_argument);
        ...
        CUSTOM_NO_THROW(new wrench::StorageServiceFileWriteRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), location, 10, 666));
        CUSTOM_THROW(new wrench::StorageServiceFileWriteRequestMessage(nullptr, location, 10, 666), std::invalid_argument);
        CUSTOM_THROW(new wrench::StorageServiceFileWriteRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), nullptr, 10, 666), std::invalid_argument);
        ...
        CUSTOM_NO_THROW(new wrench::StorageServiceFileReadRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), simgrid::s4u::Mailbox::by_name("mailbox"), location, 10, 666));
        CUSTOM_THROW(new wrench::StorageServiceFileReadRequestMessage(nullptr, simgrid::s4u::Mailbox::by_name("mailbox"), location, 10, 10), std::invalid_argument);
        CUSTOM_THROW(new wrench::StorageServiceFileReadRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), nullptr, location, 10, 10), std::invalid_argument);
        CUSTOM_THROW(new wrench::StorageServiceFileReadRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), simgrid::s4u::Mailbox::by_name("mailbox"), nullptr, 10, 10), std::invalid_argument);
        CUSTOM_THROW(new wrench::StorageServiceFileReadRequestMessage(simgrid::s4u::Mailbox::by_name("mailbox"), simgrid::s4u::Mailbox::by_name("mailbox"), location, -1.0, 10), std::invalid_argument);
