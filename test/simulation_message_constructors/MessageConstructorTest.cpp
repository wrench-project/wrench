...
TEST_F(MessageConstructorTest, ComputeServiceMessages) {
  ...
  ASSERT_NO_THROW(new wrench::ComputeServiceSubmitPilotJobRequestMessage("mailbox", pilot_job, 666));
  ASSERT_THROW(new wrench::ComputeServiceSubmitPilotJobRequestMessage("", pilot_job, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::ComputeServiceSubmitPilotJobRequestMessage("mailbox", nullptr, 666), std::invalid_argument);
...
TEST_F(MessageConstructorTest, CloudServiceMessages) {
  ...
  ASSERT_NO_THROW(new wrench::VirtualizedClusterServiceGetExecutionHostsRequestMessage("mailbox", 600));
  ASSERT_THROW(new wrench::VirtualizedClusterServiceGetExecutionHostsRequestMessage("", 666), std::invalid_argument);
...
TEST_F(MessageConstructorTest, StorageServiceMessages) {
  ...
  ASSERT_NO_THROW(new wrench::StorageServiceFileLookupRequestMessage("mailbox", file, 666));
  ASSERT_THROW(new wrench::StorageServiceFileLookupRequestMessage("", file, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileLookupRequestMessage("mailbox", nullptr, 666), std::invalid_argument);
  ...
  ASSERT_NO_THROW(new wrench::StorageServiceFileDeleteRequestMessage("mailbox", file, 666));
  ASSERT_THROW(new wrench::StorageServiceFileDeleteRequestMessage("", file, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileDeleteRequestMessage("mailbox", nullptr, 666), std::invalid_argument);
  ...
  ASSERT_NO_THROW(new wrench::StorageServiceFileCopyRequestMessage("mailbox", file, storage_service, nullptr, 666));
  ASSERT_THROW(new wrench::StorageServiceFileCopyRequestMessage("", file, storage_service, nullptr, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileCopyRequestMessage("mailbox", nullptr, storage_service, nullptr, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileCopyRequestMessage("mailbox", file, nullptr, nullptr, 666), std::invalid_argument);

  ASSERT_NO_THROW(new wrench::StorageServiceFileCopyAnswerMessage(file, storage_service, nullptr, false, true, nullptr, 666));
  ASSERT_NO_THROW(new wrench::StorageServiceFileCopyAnswerMessage(file, storage_service, nullptr, false, false, failure_cause, 666));
  ASSERT_THROW(new wrench::StorageServiceFileCopyAnswerMessage(nullptr, storage_service, nullptr, false, true, nullptr, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileCopyAnswerMessage(file, nullptr, nullptr, false,true, nullptr, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileCopyAnswerMessage(file, storage_service, nullptr, false, true, failure_cause, 666), std::invalid_argument);
  ...
  ASSERT_NO_THROW(new wrench::StorageServiceFileWriteRequestMessage("mailbox", file, 666));
  ASSERT_THROW(new wrench::StorageServiceFileWriteRequestMessage("", file, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileWriteRequestMessage("mailbox", nullptr, 666), std::invalid_argument);
  ...
  ASSERT_NO_THROW(new wrench::StorageServiceFileReadRequestMessage("mailbox", "mailbox", file, 666));
  ASSERT_THROW(new wrench::StorageServiceFileReadRequestMessage("", "mailbox", file, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileReadRequestMessage("mailbox", "", file, 666), std::invalid_argument);
  ASSERT_THROW(new wrench::StorageServiceFileReadRequestMessage("", "mailbox", nullptr, 666), std::invalid_argument);
