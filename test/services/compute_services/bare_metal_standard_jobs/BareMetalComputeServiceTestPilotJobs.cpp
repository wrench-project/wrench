...
class BareMetalComputeServiceUnsupportedPilotJobsTestWMS
    : public wrench::ExecutionController {

public:
  BareMetalComputeServiceUnsupportedPilotJobsTestWMS(
      BareMetalComputeServiceTestPilotJobs *test, std::string hostname)
