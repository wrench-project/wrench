...
WRENCH_LOG_CATEGORY(batch_service_output_csv_file_test,
                    "Log category for BatchServiceOutputCSVFileTest");
...
void BatchServiceOutputCSVFileTest::do_SimpleOutputCSVFile_test() {
  ...
  ASSERT_NO_THROW(
      wms = simulation->add(new SimpleOutputCSVFileTestWMS(this, hostname)));
