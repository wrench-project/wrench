...
std::vector<std::string> scheduling_algorithms = {"fcfs",  "easy_bf_depth0", "easy_bf_depth1", "conservative_bf", "conservative_bf_core_level"};
...
private:
    ...
    int main() override {
        ...
        {
            std::cerr << "TEST: TRYING TO SUBMIT A 4-NODE JOBS AFTER RECLAIMING\n";
