...
WRENCH_LOG_CATEGORY(
    bare_metal_compute_service_host_failures_test,
    "Log category for BareMetalComputeServiceSimulatedHostFailuresTests");
...
public:
  ...
  void
  do_BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHost_test();
  void
  do_BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnSameHost_test();
  void do_BareMetalComputeServiceRandomFailures_test();
  void
  do_BareMetalComputeServiceFailureOnServiceThatTerminatesWhenAllItsResourcesAreDown_test();
...
class
    BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHostTestWMS
    : public wrench::ExecutionController {

public:
  BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHostTestWMS(
      BareMetalComputeServiceHostFailuresTest *test, std::string &hostname)
...
private:
  ...
  int main() override {
    ...
    auto murderer = std::make_shared<wrench::ResourceSwitcher>(
        "StableHost", 100, "FailedHost1",
    ...
    auto resurector = std::make_shared<wrench::ResourceSwitcher>(
        "StableHost", 1000, "FailedHost1",
        wrench::ResourceSwitcher::Action::TURN_ON,
        wrench::ResourceSwitcher::ResourceType::HOST);
    ...
    // Submit the standard job to the compute service, making it sure it runs on
    // FailedHost1
...
TEST_F(BareMetalComputeServiceHostFailuresTest,
       OneFailureCausingWorkUnitRestartOnAnotherHost) {
  DO_TEST_WITH_FORK(
      do_BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHost_test);
}

void BareMetalComputeServiceHostFailuresTest::
    do_BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHost_test() {
  ...
  compute_service = simulation->add(new wrench::BareMetalComputeService(
      ...
      (std::map<std::string, std::tuple<unsigned long, double>>){
          std::make_pair("FailedHost1",
                         std::make_tuple(wrench::ComputeService::ALL_CORES,
                                         wrench::ComputeService::ALL_RAM)),
          std::make_pair("FailedHost2",
                         std::make_tuple(wrench::ComputeService::ALL_CORES,
                                         wrench::ComputeService::ALL_RAM))},
      "/scratch",
  ...
  wms = simulation->add(
      new BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnAnotherHostTestWMS(
          this, stable_host));
...
class BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnSameHostTestWMS
    : public wrench::ExecutionController {

public:
  BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnSameHostTestWMS(
      BareMetalComputeServiceHostFailuresTest *test, std::string &hostname)
      : wrench::ExecutionController(hostname, "test") {
    this->test = test;
  }
...
TEST_F(BareMetalComputeServiceHostFailuresTest,
       OneFailureCausingWorkUnitRestartOnSameHost) {
  DO_TEST_WITH_FORK(
      do_BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnSameHost_test);
}
...
void BareMetalComputeServiceHostFailuresTest::
  ...
  wms = simulation->add(
      new BareMetalComputeServiceOneFailureCausingWorkUnitRestartOnSameHostTestWMS(
          this, stable_host));
...
class BareMetalComputeServiceRandomFailuresTestWMS
    : public wrench::ExecutionController {

public:
  BareMetalComputeServiceRandomFailuresTestWMS(
      BareMetalComputeServiceHostFailuresTest *test, std::string &hostname)
      : wrench::ExecutionController(hostname, "test") {
    this->test = test;
  }
  ...
  int main() override {
    ...
    for (unsigned long trial = 0; trial < NUM_TRIALS; trial++) {
      ...
      auto switch1 = std::make_shared<wrench::ResourceRandomRepeatSwitcher>(
          "StableHost", seed1, 10, 100, 10, 100, "FailedHost1",
      ...
      auto switch2 = std::make_shared<wrench::ResourceRandomRepeatSwitcher>(
          "StableHost", seed2, 10, 100, 10, 100, "FailedHost2",
          wrench::ResourceRandomRepeatSwitcher::ResourceType::HOST);
      ...
      auto task = this->test->workflow->addTask("task_" + std::to_string(trial),
                                                80, 1, 1, 0);
      auto output_file = wrench::Simulation::addFile(
          "output_file_" + std::to_string(trial), 20000.0);
      task->addInputFile(this->test->input_file);
      task->addOutputFile(output_file);

      // Create a standard job
      auto job = job_manager->createStandardJob(
          task, {{this->test->input_file,
                  wrench::FileLocation::LOCATION(this->test->storage_service,
                                                 this->test->input_file)},
                 {output_file, wrench::FileLocation::LOCATION(
                                   this->test->storage_service, output_file)}});

      // Submit the standard job to the compute service, making it sure it runs
      // on FailedHost1
      job_manager->submitJob(job, this->test->compute_service, {});
...
void BareMetalComputeServiceHostFailuresTest::
    do_BareMetalComputeServiceRandomFailures_test() {
  ...
  wms = simulation->add(
      new BareMetalComputeServiceRandomFailuresTestWMS(this, stable_host));
...
class
    BareMetalComputeServiceFailureOnServiceThatTerminatesWhenAllItsResourcesAreDownTestWMS
    : public wrench::ExecutionController {
...
private:
  ...
  int main() override {
    ...
    // Starting a FailedHost1 murderer!!
    auto murderer =
        std::shared_ptr<wrench::ResourceSwitcher>(new wrench::ResourceSwitcher(
            "StableHost", 100, "FailedHost1",
            wrench::ResourceSwitcher::Action::TURN_OFF,
            wrench::ResourceSwitcher::ResourceType::HOST));
    murderer->setSimulation(this->simulation);
...
TEST_F(BareMetalComputeServiceHostFailuresTest,
       FailureOnServiceThatTerminatesWhenAllItsResourcesAreDown) {
  DO_TEST_WITH_FORK(
      do_BareMetalComputeServiceFailureOnServiceThatTerminatesWhenAllItsResourcesAreDown_test);
}
...
void BareMetalComputeServiceHostFailuresTest::
  ...
  wms = simulation->add(
      new BareMetalComputeServiceFailureOnServiceThatTerminatesWhenAllItsResourcesAreDownTestWMS(
          this, stable_host));
