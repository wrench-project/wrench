...
WRENCH_LOG_CATEGORY(network_proximity_failures,
                    "Log category for NetworkProximityHostFailuresTest");
...
protected:
  NetworkProximityHostFailuresTest() {
    ...
    std::string xml =
        ...
        "       <route src=\"StableHost\" dst=\"FailedHost1\"> <link_ctn "
        "id=\"1\""
        "/> </route>"
        "       <route src=\"StableHost\" dst=\"FailedHost2\"> <link_ctn "
        "id=\"3\""
        "/> </route>"
        "       <route src=\"StableHost\" dst=\"FailedHost3\"> <link_ctn "
        "id=\"4\""
        "/> </route>"
        "       <route src=\"FailedHost1\" dst=\"FailedHost3\"> <link_ctn "
        "id=\"5\""
        "/> </route>"
        "       <route src=\"FailedHost1\" dst=\"FailedHost2\"> <link_ctn "
        "id=\"2\""
        "/> </route>"
        "       <route src=\"FailedHost2\" dst=\"FailedHost3\"> <link_ctn "
        "id=\"2\""
        "/> </route>"
        "   </zone> "
        "</platform>";
...
private:
  ...
  int main() override {
    ...
    first_pair_to_compute_proximity =
        std::make_pair("FailedHost1", "FailedHost2");
...
void NetworkProximityHostFailuresTest::do_HostFailures_Test() {
  ...
  //    std::vector<std::string> hosts_in_network = {"FailedHost1",
  //    "FailedHost2", "FailedHost3"};
