...
private:
    ...
    int main() {
        ...
        if ((locations.find(wrench::FileLocation::LOCATION(this->test->storage_service1)) == locations.end()) ||
            (locations.find(wrench::FileLocation::LOCATION(this->test->storage_service2)) == locations.end())) {
        ...
        if (locations.find(wrench::FileLocation::LOCATION(this->test->storage_service2)) == locations.end()) {
            throw std::runtime_error("Got the wrong locations for file 1");
        }
