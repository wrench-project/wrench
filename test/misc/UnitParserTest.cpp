...
TEST_F(UnitParserTest, ParseTest) { DO_TEST_WITH_FORK(do_parse_test); }
...
void UnitParserTest::do_parse_test() {
  ...
  ASSERT_DOUBLE_EQ(wrench::UnitParser::parse_size("10MB"),
                   10.0 * 1000.0 * 1000.0);
  ASSERT_DOUBLE_EQ(wrench::UnitParser::parse_size("10GB"),
  ...
  ASSERT_DOUBLE_EQ(wrench::UnitParser::parse_compute_speed("10kf"),
                   10.0 * 1000.0);
  ASSERT_DOUBLE_EQ(wrench::UnitParser::parse_compute_speed("10Mf"),
                   10.0 * 1000.0 * 1000.0);
  ASSERT_THROW(wrench::UnitParser::parse_compute_speed("10FO"),
  ...
  ASSERT_THROW(wrench::UnitParser::parse_bandwidth("10FO"),
               std::invalid_argument);
}