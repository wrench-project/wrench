...
WRENCH_LOG_CATEGORY(wrench_core_constant_efficiency_parallel_model,
                    "Log category for ConstantEfficiencyParallelModel");
 ...
 */
ConstantEfficiencyParallelModel::ConstantEfficiencyParallelModel(
    double efficiency) {
...
//     */
//    std::vector<double>
//    ConstantEfficiencyParallelModel::getWorkPerThread(double total_work,
//    unsigned long num_threads) {
//
//        double thread_work = (total_work) / ((double)num_threads *
//        this->efficiency); std::vector<double> work_per_threads; for (unsigned
 ...
 */
double ConstantEfficiencyParallelModel::getPurelySequentialWork(
    double total_work, unsigned long num_threads) {
  return 0;
}
 ...
 * @return an amount of work (in flops)
 */
double ConstantEfficiencyParallelModel::getParallelPerThreadWork(
    double total_work, unsigned long num_threads) {
