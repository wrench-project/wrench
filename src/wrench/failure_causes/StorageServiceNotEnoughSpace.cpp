...
WRENCH_LOG_CATEGORY(wrench_core_storage_service_not_enough_space,
                    "Log category for StorageServiceNotEnoughSpace");
 ...
 */
StorageServiceNotEnoughSpace::StorageServiceNotEnoughSpace(
...
StorageServiceNotEnoughSpace::getStorageService() {
