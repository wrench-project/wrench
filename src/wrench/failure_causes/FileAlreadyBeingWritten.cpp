...
WRENCH_LOG_CATEGORY(wrench_core_file_already_being_written,
                    "Log category for FileAlreadyBeingWritten");
 ...
 */
FileAlreadyBeingWritten::FileAlreadyBeingWritten(
...
std::string FileAlreadyBeingWritten::toString() {
  return "File " + this->location->getFile()->getID() +
         " is already being copied (" + "src = " + this->location->toString() +
         ")";
}
