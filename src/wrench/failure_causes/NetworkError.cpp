 ...
 * @brief Constructor
 *
 * @param operation_type: NetworkError:OperationType::SENDING or
 * NetworkError::OperationType::RECEIVING or
...
NetworkError::NetworkError(NetworkError::OperationType operation_type,
  ...
  if (commport_name.empty()) {
    throw std::invalid_argument(
        "NetworkError::NetworkError(): invalid arguments");
  }
 ...
 */
std::string NetworkError::getCommPortName() { return this->commport_name; }

/**
 * @brief Returns the name of the message for which the error occurred
 * @return the message name
 */
std::string NetworkError::getMessageName() { return this->message_name; }
...
std::string NetworkError::toString() {
  ...
  return "Network error (" + error + ") while " + operation +
         (this->message_name.empty()
              ? ""
              : " a message with name " + this->message_name) +
         " via commport " + this->commport_name;
}
