...
//
//                WorkflowTask *child_task = workflow->getWorkflowTaskByID(child.attribute("ref").value());
//
...
//
//                    WorkflowTask *parent_task = workflow->getWorkflowTaskByID(parent_id);
//                    workflow->addControlDependency(parent_task, child_task);
//
//                }
//            }
        }
