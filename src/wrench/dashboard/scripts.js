...
function generateGraph() {
    ...
    document.getElementById('updated').innerHTML = `Data last updated on ${new Date(modified)}`
    data = data.contents
    ...
    data.forEach(function(d) {
        ...
        group.selectAll('rect')
            ...
            .on('mousemove', function() {
                ...
                var y = offset.top - 30; // 20 seems to account for the padding of the chart-block
