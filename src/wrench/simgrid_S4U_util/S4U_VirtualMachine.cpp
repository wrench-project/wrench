...
//        }
    ...
    */
     ...
     */
    std::unordered_map<std::string, std::string> S4U_VirtualMachine::getPropertyList() {
     ...
     */
    std::unordered_map<std::string, double> S4U_VirtualMachine::getMessagePayloadList() {
