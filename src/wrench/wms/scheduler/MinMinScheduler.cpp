...
namespace wrench {
    ...
    /**
     * Compare the number of flops between to WorkflowTask objects
     *
     * @param lhs: a pointer to a WorkflowTask object
     * @param rhs: a pointer to another WorkflowTask object
     * @return whether the number of flops from the left-hand-side WorkflowTask object is smaller
     */
    ...
    */
    void MinMinScheduler::schedulePilotJobs(JobManager *job_manager,
                                            ...
                                            double flops,
                                            const std::set<ComputeService *> &compute_services) {
      WRENCH_INFO("Min-Min Scheduler doesn't do anything with pilot jobs");
      return;
    }
};