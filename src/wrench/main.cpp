...
//		simulation.add(std::unique_ptr<wrench::MulticoreComputeService>(new wrench::MulticoreComputeService(executor_host, false, true, {{wrench::MulticoreComputeService::Property::STOP_DAEMON_MESSAGE_PAYLOAD, "666"}})));
