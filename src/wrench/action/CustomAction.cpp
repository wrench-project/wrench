...
namespace wrench {
    ...
    */
     ...
     */
    void CustomAction::execute(std::shared_ptr<ActionExecutor> action_executor, unsigned long num_threads, double ram_footprint) {
        this->lambda_execute(action_executor, num_threads, ram_footprint);
    }
