 ...
 */
CompoundStorageServiceMessage::CompoundStorageServiceMessage(double payload)
 ...
 */
CompoundStorageAllocationRequestMessage::
  ...
  if (answer_commport == nullptr) {
    throw std::invalid_argument(
        "CompoundStorageStorageSelectionRequestMessage::"
        "CompoundStorageStorageSelectionRequestMessage(): Invalid arguments");
  }
#endif
...
/**
 * @brief Constructor
 * @param locations: Existing or newly allocated FileLocations for requested
 * file
 * @param payload: the message size in bytes
 *
 * @throw std::invalid_argument
 ...
 * @throw std::invalid_argument
 */
CompoundStorageLookupRequestMessage::CompoundStorageLookupRequestMessage(
