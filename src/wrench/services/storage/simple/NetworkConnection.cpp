...
namespace wrench {
     ...
     */
    NetworkConnection::NetworkConnection(int type, WorkflowFile *file, std::string file_partition, std::string mailbox,
                                         std::string ack_mailbox, SimulationTimestampFileCopyStart *start_timestamp) {
        this->type = type;
        this->file = file;
