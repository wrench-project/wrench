...
ActionExecutionServiceSubmitActionRequestMessage::
  ...
  if ((reply_commport == nullptr) || (action == nullptr)) {
    throw std::invalid_argument(
        "ActionExecutionServiceSubmitActionRequestMessage::"
        "ActionExecutionServiceSubmitActionRequestMessage(): invalid argument");
  }
#endif
...
ActionExecutionServiceTerminateActionRequestMessage::
  ...
  if ((reply_commport == nullptr) || (action == nullptr)) {
    throw std::invalid_argument(
        "ActionExecutionServiceTerminateActionRequestMessage::"
        "ActionExecutionServiceTerminateActionRequestMessage(): invalid "
        "argument");
  }
#endif
  this->reply_commport = reply_commport;
...
ActionExecutionServiceActionDoneMessage::
  ...
  if (action == nullptr) {
    throw std::invalid_argument(
        "ActionExecutionServiceActionDoneMessage::"
        "ActionExecutionServiceActionDoneMessage(): invalid argument");
  }
#endif
  this->action = std::move(action);
}
