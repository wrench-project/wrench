 ...
 */
NodeAvailabilityTimeLine::NodeAvailabilityTimeLine(unsigned long max_num_nodes)
...
void NodeAvailabilityTimeLine::print() {
  ...
  for (auto &availability_timeslot : this->availability_timeslots) {
    std::cerr << availability_timeslot.first << "("
              << availability_timeslot.second.num_nodes_utilized << ") | ";
 ...
 */
void NodeAvailabilityTimeLine::update(bool add, u_int32_t start, u_int32_t end,
 ...
 */
u_int32_t
NodeAvailabilityTimeLine::findEarliestStartTime(uint32_t duration,
                                                unsigned long num_nodes) {
  uint32_t start_time = UINT32_MAX;
  uint32_t remaining_duration = duration;

  for (auto &availability_timeslot : this->availability_timeslots) {
    unsigned long available_nodes =
        this->max_num_nodes - availability_timeslot.second.num_nodes_utilized;
...
NodeAvailabilityTimeLine::getJobsInFirstSlot() {
