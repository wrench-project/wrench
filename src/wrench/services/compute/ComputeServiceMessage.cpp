 ...
 * @param service_specific_args: a map of extra arguments (each specified by a
 * name and value, both strings) required by some services
 * @param payload: message size in bytes
 *
...
ComputeServiceSubmitCompoundJobRequestMessage::
  ...
  if ((answer_commport == nullptr) || (job == nullptr)) {
    throw std::invalid_argument(
        "ComputeServiceSubmitCompoundJobRequestMessage::"
        "ComputeServiceSubmitCompoundJobRequestMessage(): Invalid arguments");
  }
#endif
...
ComputeServiceSubmitCompoundJobAnswerMessage::
    ComputeServiceSubmitCompoundJobAnswerMessage(
        ...
        std::shared_ptr<ComputeService> compute_service, bool success,
  ...
  if ((job == nullptr) || (compute_service == nullptr) ||
    ...
    throw std::invalid_argument(
        "ComputeServiceSubmitCompoundJobAnswerMessage::"
        "ComputeServiceSubmitCompoundJobAnswerMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
 ...
 * @throw std::invalid_arguments
 */
ComputeServiceCompoundJobDoneMessage::ComputeServiceCompoundJobDoneMessage(
    std::shared_ptr<CompoundJob> job, std::shared_ptr<ComputeService> cs,
    double payload)
    : ComputeServiceMessage(payload) {
  ...
  if ((job == nullptr) || (cs == nullptr)) {
    throw std::invalid_argument(
        ...
        "ComputeServiceCompoundJobDoneMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
 ...
 * @throw std::invalid_argument
 */
ComputeServiceCompoundJobFailedMessage::ComputeServiceCompoundJobFailedMessage(
    std::shared_ptr<CompoundJob> job, std::shared_ptr<ComputeService> cs,
    double payload)
    : ComputeServiceMessage(payload) {
#ifdef WRENCH_INTERNAL_EXCEPTIONS
  if ((job == nullptr) || (cs == nullptr)) {
    throw std::invalid_argument(
        ...
        "ComputeServiceCompoundJobFailedMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
  this->compute_service = std::move(cs);
...
ComputeServiceTerminateCompoundJobRequestMessage::
  ...
  if ((answer_commport == nullptr) || (job == nullptr)) {
    throw std::invalid_argument(
        "ComputeServiceTerminateCompoundJobRequestMessage::"
        "ComputeServiceTerminateCompoundJobRequestMessage(): Invalid "
        "arguments");
  }
#endif
  this->answer_commport = answer_commport;
 ...
 * @param compute_service: the compute service that was executing the standard
 * job
 * @param success: true on success, false otherwise
 * @param failure_cause: cause of the failure (nullptr if success == true)
 * @param payload: message size in bytes
...
ComputeServiceTerminateCompoundJobAnswerMessage::
  ...
  if ((job == nullptr) || (compute_service == nullptr) ||
    ...
    throw std::invalid_argument(
        "ComputeServiceTerminateCompoundJobAnswerMessage::"
        "ComputeServiceTerminateCompoundJobAnswerMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
  this->compute_service = std::move(compute_service);
 ...
 * @throw std::invalid_argument
 */
ComputeServicePilotJobStartedMessage::ComputeServicePilotJobStartedMessage(
    std::shared_ptr<PilotJob> job, std::shared_ptr<ComputeService> cs,
    double payload)
    : ComputeServiceMessage(payload) {
#ifdef WRENCH_INTERNAL_EXCEPTIONS
  if ((job == nullptr) || (cs == nullptr)) {
    throw std::invalid_argument(
        ...
        "ComputeServicePilotJobStartedMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
  this->compute_service = std::move(cs);
 ...
 * @throw std::invalid_argument
 */
ComputeServicePilotJobExpiredMessage::ComputeServicePilotJobExpiredMessage(
    std::shared_ptr<PilotJob> job, std::shared_ptr<ComputeService> cs,
    double payload)
    : ComputeServiceMessage(payload) {
#ifdef WRENCH_INTERNAL_EXCEPTIONS
  if ((job == nullptr) || (cs == nullptr)) {
    throw std::invalid_argument(
        "ComputeServicePilotJobExpiredMessage::"
        "ComputeServicePilotJobExpiredMessage(): Invalid arguments");
  }
#endif
  this->job = std::move(job);
  this->compute_service = std::move(cs);
...
ComputeServiceResourceInformationRequestMessage::
    ComputeServiceResourceInformationRequestMessage(
        S4U_CommPort *answer_commport, const std::string &key, double payload)
    : ComputeServiceMessage(payload) {
#ifdef WRENCH_INTERNAL_EXCEPTIONS
  if ((answer_commport == nullptr) or key.empty()) {
    throw std::invalid_argument(
        "ComputeServiceResourceInformationRequestMessage::"
        "ComputeServiceResourceInformationRequestMessage(): Invalid arguments");
  }
#endif
  this->answer_commport = answer_commport;
  this->key = key;
...
ComputeServiceIsThereAtLeastOneHostWithAvailableResourcesRequestMessage::
  ...
  if (not answer_commport) {
    throw std::invalid_argument("ComputeServiceIsThereAtLeastOneHostWithAvailab"
                                "leResourcesRequestMessage::"
                                "ComputeServiceIsThereAtLeastOneHostWithAvailab"
                                "leResourcesRequestMessage(): "
                                "Invalid arguments");
  }
#endif
...
ComputeServiceIsThereAtLeastOneHostWithAvailableResourcesAnswerMessage::
    ...
    : ComputeServiceMessage(payload), answer(answer) {}
} // namespace wrench
