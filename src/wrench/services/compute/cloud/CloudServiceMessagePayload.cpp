...
namespace wrench {
    ...
    SET_MESSAGEPAYLOAD_NAME(CloudServiceMessagePayload, MIGRATE_VM_REQUEST_MESSAGE_PAYLOAD);
    SET_MESSAGEPAYLOAD_NAME(CloudServiceMessagePayload, MIGRATE_VM_ANSWER_MESSAGE_PAYLOAD);
}
