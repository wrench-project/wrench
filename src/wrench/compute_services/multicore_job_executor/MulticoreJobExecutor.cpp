...
namespace wrench {
    ...
    std::string MulticoreJobExecutor::getPropertyString(MulticoreJobExecutor::Property property) {
      switch (property) {
        case STOP_DAEMON_MESSAGE_PAYLOAD:
          return "STOP_DAEMON_MESSAGE_PAYLOAD";
        case DAEMON_STOPPED_MESSAGE_PAYLOAD:
          return "DAEMON_STOPPED_MESSAGE_PAYLOAD";
        case JOB_TYPE_NOT_SUPPORTED_MESSAGE_PAYLOAD:
          return "JOB_TYPE_NOT_SUPPORTED_MESSAGE_PAYLOAD";
        case RUN_STANDARD_JOB_MESSAGE_PAYLOAD:
          return "RUN_STANDARD_JOB_MESSAGE_PAYLOAD";
        case STANDARD_JOB_DONE_MESSAGE_PAYLOAD:
          return "STANDARD_JOB_DONE_MESSAGE_PAYLOAD";
        case STANDARD_JOB_FAILED_MESSAGE_PAYLOAD:
          return "STANDARD_JOB_FAILED_MESSAGE_PAYLOAD";
        case RUN_PILOT_JOB_MESSAGE_PAYLOAD:
          return "RUN_PILOT_JOB_MESSAGE_PAYLOAD";
        case PILOT_JOB_STARTED_MESSAGE_PAYLOAD:
          return "PILOT_JOB_STARTED_MESSAGE_PAYLOAD";
        case PILOT_JOB_EXPIRED_MESSAGE_PAYLOAD:
          return "PILOT_JOB_EXPIRED_MESSAGE_PAYLOAD";
        case PILOT_JOB_FAILED_MESSAGE_PAYLOAD:
          return "PILOT_JOB_FAILED_MESSAGE_PAYLOAD";
        case NUM_IDLE_CORES_REQUEST_MESSAGE_PAYLOAD:
          return "NUM_IDLE_CORES_REQUEST_MESSAGE_PAYLOAD";
        case NUM_IDLE_CORES_ANSWER_MESSAGE_PAYLOAD:
          return "NUM_IDLE_CORES_ANSWER_MESSAGE_PAYLOAD";
        case TTL_REQUEST_MESSAGE_PAYLOAD:
          return "TTL_REQUEST_MESSAGE_PAYLOAD";
        case TTL_ANSWER_MESSAGE_PAYLOAD:
          return "TTL_ANSWER_MESSAGE_PAYLOAD";

        default:
          throw new std::invalid_argument(
                  "MulticoreJobExecutor property" + std::to_string(property) + "has no string name");
      }
    }
